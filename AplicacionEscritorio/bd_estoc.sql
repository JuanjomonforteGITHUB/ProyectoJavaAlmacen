...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2018 a las 15:07:37
...
(8, 'Bloc 1', 'passadis 4', 'lleixa 1'),
(9, 'Bloc 7', 'passadis 5', 'lleixa 7');
...
(7, 'Panel LED 29\"', 'foto1.jpg', 2, 'Panel LED to guapo', 5, 15),
(8, 'Tiras LED verdes', 'foto1.jpg', 3, 'Tiras LED 40w', 10, 10.99);
...
--
ALTER TABLE `tbl_estoc`
  MODIFY `estoc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
