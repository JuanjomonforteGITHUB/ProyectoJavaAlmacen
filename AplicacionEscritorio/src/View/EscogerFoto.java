 ...
 * @author 4784.joan23
 */
public class EscogerFoto extends javax.swing.JFrame {

    /**
     * Creates new form EscogerFoto
     */
    public EscogerFoto() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EscogerFoto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EscogerFoto().setVisible(true);
            }
        });
    }
